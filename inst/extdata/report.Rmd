...
```{r Top10_1_mobility_001_success_2, fig.showtext=TRUE, eval=FALSE}
...
```{r Top10_2_mobility_002_success_2, fig.showtext=TRUE, eval=FALSE}
...
```{r Top10_3_dishwasher_to_eco_mode_challenge_start_1, fig.showtext=TRUE, eval=FALSE}
...
```{r Top10_4_dryerUsesPerWeek, fig.showtext=TRUE, eval=FALSE}
...
```{r Top10_5_diet_003_success_2, fig.showtext=TRUE, eval=FALSE}
...
```{r Top10_6_shower_duration, fig.showtext=TRUE, eval=FALSE}
...
```{r Top10_7_energy_002_success_2, fig.showtext=TRUE, eval=FALSE}
...
```{r Top10_8_waste_002_success_2, fig.showtext=TRUE, eval=FALSE}
...
##### Please select the most relevant option that led to your success with this challenge: 
```{r Top10_9_energy_008_success_2, fig.showtext=TRUE, eval=FALSE}
...
##### Please select the most relevant option that led to your success with this challenge: 
```{r Top10_10_energy_006_success_2, fig.showtext=TRUE, eval=FALSE}
